...
% -- Predikat diagnosa/1 digunakan untuk menanyakan dan menyimpan statusgejala X.
diagnosa(G) :-
    pertanyaan(G),
    writeln(" (y/t)"),
    read(Jawaban),
...
% -- Predikat gejala/1 dipanggil untuk memerika status gejala
% daridatabase, -- atau menanyakan user terkait gejala tersebut.
